...
def input_parser(plan, input_args):
    ...
    result["explorer_params"] = get_default_explorer_params()
    ...
    return struct(
        participants=[
            struct(
                ...
                zond_metrics_exporter_enabled=participant[
                    "zond_metrics_exporter_enabled"
                ],
        ...
        zond_metrics_exporter_enabled=result["zond_metrics_exporter_enabled"],
...
def parse_network_params(plan, input_args):
    ...
    for index, participant in enumerate(result["participants"]):
        ...
        if zond_metrics_exporter_enabled == None:
            participant["zond_metrics_exporter_enabled"] = result[
                "zond_metrics_exporter_enabled"
            ]
...
def default_participant():
    return {
        ...
        "zond_metrics_exporter_enabled": None,
