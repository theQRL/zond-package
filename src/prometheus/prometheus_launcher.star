...
def launch_prometheus(
    ...
    zond_metrics_exporter_contexts,
...
def get_metrics_jobs(
    ...
    # Adding zond-metrics-exporter metrics jobs
    for context in zond_metrics_exporter_contexts:
        if context != None:
            metrics_jobs.append(
                new_metrics_job(
                    job_name="zond-metrics-exporter-{0}".format(context.pair_name),
                    endpoint="{}:{}".format(
                        context.ip_addr,
