...
WEB3SIGNER_HTTP_PORT_NUM = 9000
WEB3SIGNER_HTTP_PORT_ID = "http"
WEB3SIGNER_METRICS_PORT_NUM = 9001
WEB3SIGNER_METRICS_PORT_ID = "metrics"

METRICS_PATH = "/metrics"

WEB3SIGNER_USED_PORTS = {
    WEB3SIGNER_HTTP_PORT_ID: shared_utils.new_port_spec(
        WEB3SIGNER_HTTP_PORT_NUM,
        shared_utils.TCP_PROTOCOL,
        shared_utils.HTTP_APPLICATION_PROTOCOL,
    ),
    WEB3SIGNER_METRICS_PORT_ID: shared_utils.new_port_spec(
        WEB3SIGNER_METRICS_PORT_NUM,
        shared_utils.TCP_PROTOCOL,
        shared_utils.HTTP_APPLICATION_PROTOCOL,
    ),
}
