...
This is a [Kurtosis][kurtosis-repo] package that will spin up a private Zond testnet over Docker or Kubernetes with multi-client support and other useful network tools (transaction spammer, monitoring tools, etc). Kurtosis packages are entirely reproducible and composable, so this will work the same way over Docker or Kubernetes, in the cloud or locally on your machine.
...
participants:
  ...
  # Participant specific flags
    ...
    # Enables Zond Metrics Exporter for this participant. Can be set globally.
    # Defaults null and then set to global zond_metrics_exporter_enabled (false)
    zond_metrics_exporter_enabled: null
...
# Enables Zond Metrics Exporter for all participants
# Defaults to false
zond_metrics_exporter_enabled: false
...
```sh
  ...
  "com.kurtosistech.custom.zond-package-client-image": "theqrl-qrysm-latest",
